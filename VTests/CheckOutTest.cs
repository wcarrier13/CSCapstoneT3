...
namespace Lizst
{
    //Tests that pieces are checked out to an ensemble correctly
    [TestFixture]
    public class CheckOutTest
    {
        ...
        {
            //New tests will have to change the individual score and musician values
            ...
            driver.FindElement(By.Name("musician 16 score 160")).Click();
            new SelectElement(driver.FindElement(By.Name("musician 16 score 160"))).SelectByText("Flute 3");
            driver.FindElement(By.Name("musician 16 score 160")).Click();
