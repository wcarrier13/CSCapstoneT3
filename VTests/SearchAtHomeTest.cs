...
namespace Lizst
{
    //Tests that the search box on the home screen functions properly
    [TestFixture]
    public class SearchOnHomeTest
    {
        ...
        [Test]
        public void TheSearchOnHomeTest()
        {
            ...
            driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='UNO Music Library'])[1]/following::input[1]")).SendKeys("The New");
